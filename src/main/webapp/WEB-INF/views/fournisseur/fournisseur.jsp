		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800"><fmt:message key="common.fournisseur" /></h1>
			...
			<div class="col-lg-12">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item"><a href='<c:url value="/fournisseur/nouveau" />'><i class="fa fa-plus">&nbsp;<fmt:message key="common.ajouter"/></i></a></li>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message key="fournisseur.liste" /></h6>
            </div>
	                    ...
	                    <tr>
	                      ...
	                      <td>
		                      <c:url value="/fournisseur/modifier/${fournisseur.getIdFournisseur() }" var="urlModif"></c:url>
		                      	...
		                      	&nbsp;|&nbsp;
		                      	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalFournisseur${fournisseur.getIdFournisseur() }"><i class="fa fa-trash-alt">&nbsp;<fmt:message key="common.supprimer"/></i></a>
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								      	<fmt:message key="common.confirm.suppression.msg"/>&nbsp;<label>${fournisseur.getPrenom() }&nbsp;${fournisseur.getNom() } ?</label>
								      </div>
