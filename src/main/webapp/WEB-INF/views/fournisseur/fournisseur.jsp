		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800"><fmt:message code="common.fournisseur" /></h1>
			...
			<div class="col-lg-12">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item"><a href='<c:url value="/fournisseur/nouveau" />'><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter"/></i></a></li>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message code="fournisseur.liste" /></h6>
            </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  	...
                  	<c:forEach items="${fournisseurs }" var="fournisseur">
	                    <tr>
	                      <td><img src="<%=request.getContextPath()%>/resources/img/${fournisseur.getPhoto() }" width="50px" height="50px"></td>
	                      <td>${fournisseur.getNom() }</td>
	                      <td>${fournisseur.getPrenom() }</td>
	                      <td>${fournisseur.getAdresse() }</td>
	                      <td>${fournisseur.getMail() }</td>
	                      <td>
		                      <c:url value="/fournisseur/modifier/${fournisseur.getIdFournisseur() }" var="urlModif"></c:url>
		                      	<a href="${urlModif }"><i class="fa fa-edit">&nbsp;<fmt:message code="common.modifier"/></i></a>
		                      	&nbsp;|&nbsp;
		                      	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalFournisseur${fournisseur.getIdFournisseur() }"><i class="fa fa-trash-alt">&nbsp;<fmt:message code="common.supprimer"/></i></a>
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								      	<fmt:message code="common.confirm.suppression.msg"/>&nbsp;<label>${fournisseur.getPrenom() }&nbsp;${fournisseur.getNom() } ?</label>
								      </div>
								      <div class="modal-footer">
								      	<c:url value="/fournisseur/supprimer/${fournisseur.getIdFournisseur() }" var="urlSuppression"></c:url>
